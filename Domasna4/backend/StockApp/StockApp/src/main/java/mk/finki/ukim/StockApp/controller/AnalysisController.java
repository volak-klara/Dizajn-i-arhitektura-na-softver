...
public class AnalysisController {
    ...
    @GetMapping("/fundamental/{companyId}")
    public ResponseEntity<?> getFundamentalAnalysis(@PathVariable String companyId) {
        String pythonApiUrl = "http://localhost:8000/fundamental-analysis/" + companyId;
